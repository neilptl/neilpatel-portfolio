...
This is a static portfolio site designed for GitHub Pages.
...
2. Upload these files or push this folder to the repository.
3. Make sure the default branch is named `main`.
4. In GitHub, open `Settings > Pages`.
5. Under `Build and deployment`, choose `GitHub Actions`.
6. Push to `main` and wait for the Pages workflow to finish.
7. Your site will be published at the GitHub Pages URL shown in the deployment.
